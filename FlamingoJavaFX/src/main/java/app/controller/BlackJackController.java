...
public class BlackJackController implements Initializable {
	...
	private PathTransition CreatePathTransition(Point2D fromPoint, Point2D toPoint, ImageView img) {
		...
		path.getElements().add(new CubicCurveTo(toPoint.getX() / 2, toPoint.getY() / 2, toPoint.getX(),
				toPoint.getY() / 2, toPoint.getX() + img.getFitWidth(), toPoint.getY() + img.getFitHeight()));
